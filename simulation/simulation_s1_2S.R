...
fname <- paste0('stan_fit/', model, '/', '_prior2.RData')
...
summary.parameters[1:L0, c(1, 3, 4)] <- d0
summary.parameters[(L0+1):(L0+L1), c(1, 3, 4)] <- d1
...
save(list = c('summary.parameters', 'summary.mean', 
