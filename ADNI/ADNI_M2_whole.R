...
fname = 'stan_fit/M2_whole_prior2.RData'
...
write.csv(summ, file = 'RData/summary_posterior_M2_whole.csv')

fname <- paste0('RData/summary_posterior_M2_whole.RData')
...
save(list = 'l', file = 'RData/summary_posterior_M2_whole_MP.RData')
