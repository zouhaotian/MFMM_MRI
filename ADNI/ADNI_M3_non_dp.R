## Dynamic Prediction for M3: non-mixed functional model ##
...
fname = paste0('stan_fit/M3_non_dp/', seed, '.RData')
...
fname <- paste0('result/M3_non_dp/', seed, '.RData')
